...
ActiveRecord::Schema.define(version: 20151218043051) do
  ...
  create_table "students", force: :cascade do |t|
    ...
    t.string   "cap_name",      limit: 255
    t.string   "cap_desc",      limit: 255
    t.string   "cap_url",       limit: 255
    t.string   "cap_ss",        limit: 255
    t.datetime "created_at",                  null: false
    t.datetime "updated_at",                  null: false
  end
